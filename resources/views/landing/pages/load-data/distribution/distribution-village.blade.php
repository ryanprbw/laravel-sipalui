<x-card>
    <x-slot:header>
        <h5>DATA SEBARAN {{ $city->city_name }} / {{ str()->upper($district->district_name) }}</h5>
    </x-slot:header>
    <div class="mb-3">
        <a href="{{ route('distribution.export-village', ['city' => $district->city_code, 'district' => $district->district_code]) }}"
